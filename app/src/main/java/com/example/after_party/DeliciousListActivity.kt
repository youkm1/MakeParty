...
class DeliciousListActivity : ComponentActivity() {
...
@Preview
@Composable
fun PreviewDeliciousListScreen() {
    After_PartyTheme {
        PopularListScreen()
    }
}